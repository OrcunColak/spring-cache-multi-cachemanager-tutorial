...
public class EmployeeController {
    ...
    @PostMapping("/save")
    @Cacheable(key = "#employeeDTO.id", cacheManager = "redisCacheManager")
    ...
    @PostMapping("/update")
    @CachePut(key = "#employeeDTO.id", unless = "#employeeDTO != null", cacheManager = "redisCacheManager")
    ...
    @Cacheable(key = "#id", condition = "#id != null", sync = true, cacheManager = "redisCacheManager")
    ...
    @CacheEvict(key = "#id", condition = "#id != null", beforeInvocation = true, cacheManager = "redisCacheManager")
    ...
    @CacheEvict(allEntries = true, cacheManager = "redisCacheManager")
